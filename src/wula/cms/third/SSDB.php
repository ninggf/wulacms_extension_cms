...
class SSDB {
	 ...
	 * @throws \wula\cms\third\SSDBTimeoutException
	 */
	function exec() {
		$ret = [];
	...
	/**
	 * @return bool|null|SSDB_Response|\wula\cms\third\SSDB
	 * @throws \Exception
	 */
	function request() {
		$args = func_get_args();
	...
	/**
	 * @param                               $cmd
	 * @param \wula\cms\third\SSDB_Response $resp
	 *
	 * @return bool|null|\wula\cms\third\SSDB_Response
	 */
	 ...
	 * @param array $kvs
	 *
	 * @return bool|null|\wula\cms\third\SSDB|\wula\cms\third\SSDB_Response
	 * @throws \wula\cms\third\SSDBException
	 */
	function multi_set($kvs = []) {
		$args = [];
		foreach ($kvs as $k => $v) {
			$args[] = $k;
			$args[] = $v;
	 ...
	 * @param $params
	 *
	 * @return \wula\cms\third\SSDB_Response
	 * @throws \wula\cms\third\SSDBException
	 * @throws \wula\cms\third\SSDBTimeoutException
	 */
